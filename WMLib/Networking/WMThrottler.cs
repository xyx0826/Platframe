...
{
    /// <summary>
    /// <see cref="SemaphoreSlim"/>-based lightweight API throttler.
    /// Credits: Jack Leitch http://www.jackleitch.net/2010/10/better-rate-limiting-with-dot-net/
    /// </summary>
    public class WMThrottler : IDisposable
    {
        ...
        /// </exception>
        public WMThrottler(int occurrences, TimeSpan timeUnit)
        {
            // Check the arguments.
            if (occurrences <= 0)
